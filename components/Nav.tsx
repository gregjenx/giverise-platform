...
export default function Nav() {
  ...
  return (
    <>
      <style>{`
        .gt-nav-links { display: flex; }
        .gt-hamburger { display: none; }
        .gt-mobile-backdrop { display: none; }
        .gt-mobile-menu { display: none; }
        @media (max-width: 767px) {
          .gt-nav-links { display: none !important; }
          .gt-hamburger { display: flex !important; }
          .gt-mobile-backdrop { display: block !important; }
          .gt-mobile-menu { display: block !important; }
        }
      `}</style>
      <header
        style={{
